...
export default function About() {
    const itens = [
        ...
        },
        {
            ...
            Descricao:
                "Um RPG massivo baseado no universo de Dungeons & Dragons. Reúna seu grupo e retorne aos Reinos Esquecidos em uma história de companheirismo, traição e a atração pelo poder absoluto, enquanto um parasita Devorador de Mentes cresce em seu cérebro.",
            Preco: "R$ 199,99",
    ...
    const adicionarAoCarrinho = (index) => {
        setCarrinho((prev) => (prev.includes(index) ? prev : [...prev, index]));
    };
    const comprado = {
        nome: "Lethal Company",
    };
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            >
                                ...
                                {carrinho.includes(index) ? (
                                    <Pressable
                                        style={
                                            styles.catalogoItemBotaoDesabilitado
                                        }
                                        disabled={true}
                                    >
                                        <Text
                                            style={
                                                styles.catalogoItemBotaoTexto
                                            }
                                        >
                                            Item no carrinho
                                        </Text>
                                    ...
                                    <Pressable
                                        style={styles.catalogoItemBotao}
                                        onPress={() =>
