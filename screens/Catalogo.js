...
export default function About() {
    const itens = [
        ...
        {Nome: 'Hades', Descricao: 'Desafie o deus dos mortos neste roguelike de ação em masmorras. Como Zágreu, príncipe do Submundo, você usará os poderes e armas míticas do Olimpo para se libertar das garras de seu pai, Hades, ficando mais forte a cada tentativa de fuga.', Preco: 'R$ 400,00', Cartaz: require('../assets/hades.jpg')},
        ...
        {Nome: 'God of War (2018)', Descricao: 'Um jogo de ação e aventura que reinventa a franquia God of War. Jogue como Kratos, que agora vive em um mundo baseado na mitologia nórdica, enquanto tenta proteger seu filho Atreus.', Preco: 'R$ 1100,00', Cartaz: require('../assets/godofwar(2018).jpg')},
